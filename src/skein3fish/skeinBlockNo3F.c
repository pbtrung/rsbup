                             ...
                             size_t blkCnt, size_t byteCntAdd)
{
    ...
    do  {
        ...
        threefishSetKey(&key, Threefish256, (uint64_t *)ctx->X, (uint64_t *)tweak);

        Skein_Get64_LSB_First(w, blkPtr, SKEIN_256_STATE_WORDS);   /* get input block in little-endian format */

        threefishEncryptBlockWords(&key, (uint64_t *)w, (uint64_t *)ctx->X);
                             ...
                             size_t blkCnt, size_t byteCntAdd)
{
    ...
    do  {
        ...
        threefishSetKey(&key, Threefish512, (uint64_t *)ctx->X, (uint64_t *)tweak);
                              ...
                              size_t blkCnt, size_t byteCntAdd)
{
    ...
    do  {
        ...
        threefishSetKey(&key, Threefish1024, (uint64_t *)ctx->X, (uint64_t *)tweak);
